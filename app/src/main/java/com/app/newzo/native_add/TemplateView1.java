...
package com.app.newzo.native_add;
...
public class TemplateView1 extends FrameLayout {
    ...
    public String getTemplateTypeName() {
       /* if (templateType == R.layout.gnt_medium_template_view) {
        ...
        if (templateType == R.layout.add_layout) {
        ...
        try {
            templateType =
                    attributes.getResourceId(
                            ...
                            R.styleable.TemplateView_gnt_template_type, R.layout.add_layout);
        } finally {
            attributes.recycle();
        }
    ...
    public void onFinishInflate() {
        ...
        nativeAdView = (NativeAdView) findViewById(R.id.ad1_native_adView);
        primaryView = (TextView) findViewById(R.id.ad1_heading);
        secondaryView = (TextView) findViewById(R.id.ad1_advitiser2);
        tertiaryView = (TextView) findViewById(R.id.ad1_desc);

        ratingBar = (RatingBar) findViewById(R.id.ad1_starrating2);
        ratingBar.setEnabled(false);

        callToActionView = (Button) findViewById(R.id.ad1_button);
        iconView = (ImageView) findViewById(R.id.ad1_imageView);
